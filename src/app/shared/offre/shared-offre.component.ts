...
@Component({
  selector: 'app-shared-offre',
  templateUrl: './shared-offre.component.html',
  styleUrls: ['./shared-offre.component.scss']
}) 
export class SharedOffreComponent implements OnInit {
