...
@Component({
  selector: 'app-offre-full-detail',
  templateUrl: './offre-full-detail.component.html',
  styleUrls: ['./offre-full-detail.component.scss'],
  providers: [{
...
export class OffreFullDetailComponent implements OnInit{
  ...
  loadOffreInfo(offre: Offre){
    try {
 
      this.current_user_offre = offre;
      if(!this.authService.getLoginState()){
